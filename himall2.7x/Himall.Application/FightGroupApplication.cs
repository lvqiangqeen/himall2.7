...
namespace Himall.Application
{
    ...
    public class FightGroupApplication
    {
        ...
        /// </summary>
        /// <param name="id"></param>
        public static void XcxCancelActive(long id)
        {
            _iFightGroupService.XcxCancelActive(id);
        }


        public static void DeleteActive(long id)
        {
            _iFightGroupService.DeleteActive(id);
        }
        /// <summary>
        /// 获取拼团活动
        /// </summary>
        ...
        public static FightGroupActiveImgInfo XcxGetActiveImg(long id)
        {
            return _iFightGroupService.GetActiveImg(id);
        }
        ...
        public static List<FightGroupActiveItemInfo> GetActiveItemsInfos(long id)
        {
            var data = _iFightGroupService.GetXcxActiveItems(id);
            return data;
        }
        /// <summary>
        /// 获取拼团项用于新增活动
