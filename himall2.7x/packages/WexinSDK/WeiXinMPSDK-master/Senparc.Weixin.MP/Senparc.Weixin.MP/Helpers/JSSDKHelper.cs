...
namespace Senparc.Weixin.MP.Helpers
{
    public class JSSDKHelper
    {
        ...
        /// <returns></returns>
        public string GetCardSign(string appId, string appSecret, string locationId, string noncestr, string timestamp, string cardId, string cardType, int outerid=0)
        {
            //清空Parameters
            ClearParameter();
            ...
            SetParameter("outer_id", outerid.ToString());
        ...
        /// <summary>
        /// 获取卡券签名CardSign
        /// <para>150909新版api</para>
        /// </summary>
        /// <returns></returns>
        public string GetCardSign2015(string apiticket, string noncestr, string timestamp, string cardId, string code = "", string openid="")
        {
            //清空Parameters
            ClearParameter();

            SetParameter("apiticket", apiticket);
            SetParameter("nonce_str", noncestr);
            SetParameter("times_tamp", timestamp);
            SetParameter("card_id", cardId);
