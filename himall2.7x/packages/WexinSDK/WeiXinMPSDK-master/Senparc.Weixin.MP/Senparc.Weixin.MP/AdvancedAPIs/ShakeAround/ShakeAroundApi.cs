...
namespace Senparc.Weixin.MP.AdvancedAPIs.ShakeAround
{
    ...
    public static class ShakeAroundApi
    {
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static WxJsonResult DeviceUpdate( string accessTokenOrAppId , long deviceId , string uuId , long major , long minor , string comment , long poiId = 0 , int timeOut = Config.TIME_OUT )
        {
            return ApiHandlerWapper.TryCommonApi( accessToken =>
            {
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static DeviceListResultJson SearchDeviceById( string accessTokenOrAppId , List<DeviceApply_Data_Device_Identifiers> deviceIdentifiers , int timeOut = Config.TIME_OUT )
        {
            return ApiHandlerWapper.TryCommonApi( accessToken =>
            {
                var data = new
                ...
                return CommonJsonSend.Send<DeviceListResultJson>( accessToken , searchDeviceUrl , data , CommonJsonSendType.POST , timeOut );
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static DeviceListResultJson SearchDeviceByRange( string accessTokenOrAppId , int begin , int count , int timeOut = Config.TIME_OUT )
        {
            return ApiHandlerWapper.TryCommonApi( accessToken =>
            {
                var data = new
        ...
        public static UploadImageResultJson UploadImage( string accessTokenOrAppId , string file , int timeOut = Config.TIME_OUT )
        {
            return ApiHandlerWapper.TryCommonApi( accessToken =>
            {
                ...
                return HttpUtility.Post.PostFileGetJson2<UploadImageResultJson>( url , null , fileDictionary , null , timeOut: timeOut );
            } , accessTokenOrAppId );
        }
        ...
        public static AddPageResultJson AddPage( string accessTokenOrAppId , string title , string description , string pageUrl ,
            string iconUrl , string comment = "" , int timeOut = Config.TIME_OUT )
        {
            return ApiHandlerWapper.TryCommonApi( accessToken =>
            {
