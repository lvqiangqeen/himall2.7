...
namespace Himall.Web.Areas.Admin.Controllers
{
    public class WeiBigWheelController : Controller
    {
        ...
        {
            var result = WeiActivityApplication.Get(name.Trim(),WeiActivityType.Roulette, page, rows);
            var datas = result.Models.ToList().Where(p => p.activityType == WeiActivityType.Roulette); ;
        ...
        public ActionResult Add(FormCollection fc)
        {
            ...
            string url = "http://" + Request.Url.Host.ToString() + "/m-Mobile/BigWheel/index/";
            model.codeUrl = url;
